...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'篇','prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'尾页','theme'=>' 共有贴子数%totalRow% %header%  %first% %upPage%  %prePage%  %linkPage%  %nextPage% %downPage%  %end% 共%totalPage% 页');
    // 默认分页变量名
    protected $varPage;
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<span class='current' style='background-color: rgb(236, 148, 31);'>".$page."</span>";
                }
            }
        }
        $pageStr     =   str_replace(
